...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="Appoinment/index.php" class="nav-item nav-link">Appoinment</a>
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="User_Education.php" class="dropdown-item active">User Education</a>
                            </div>
                        </div>
    ...
    <div class="course-top" id="curse">
        ...
        <section class="online-course">
            <div class="online-box">
                <iframe width="400" height="300" src="https://www.youtube.com/embed/8919Zm8Gi4U?si=eC6hXf-BoHXOCfFd" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>

            <div class="online-box">
                <iframe width="400" height="300" src="https://www.youtube.com/embed/9bvMv5dQ7RU?si=adVvHtk4M5H1c9Fu" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>

            <div class="online-box">
                <iframe width="400" height="300" src="https://www.youtube.com/embed/ENlo5JOwL2Q?si=vNXiDolkJJuz3ayx" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
